...
const TARIF_BOOST       = "10€";const CATEGORIES = ["Concert","Expo","Marché","Fête","Sport","Culture","Soirée","Spectacle","Autre"];
const CAT_COL = {
...
const sbtn = (bg) => ({ background:bg,color:"#fff",border:"none",padding:"7px 14px",borderRadius:5,
  cursor:"pointer",fontWeight:800,fontSize:".82rem",fontFamily:"Nunito,sans-serif" });export default function App() {
  ...
  if (view === "agenda") return (
    ...
    </div>if (view === "detail" && selected) return (
    <div style={{fontFamily:"Nunito,sans-serif",background:"#f9f4f0",minHeight:"100vh"}}>
      {hdr}
